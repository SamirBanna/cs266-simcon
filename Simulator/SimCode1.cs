...
namespace Robotics.SimulationTutorial1
{
    ...
    public class SimulationTutorial1 : DsspServiceBase
    {
        ...
        protected override void Start()
        {
            ...
            TextReader tr = new StreamReader("samples/SimulationTutorials/Tutorial1/Simulator/Game Parameters.txt");
            ...
            WorldPair MyWorld = os.RandomBoard(os.Algo.robots, os.Algo.barriers, os.Algo.food, os.Algo.dim);
            Thread.Sleep(3000);
        ...
        public class OurSimulator
        {
            ...
            public OurSimulator Finished()
            {
                ...
                if (MyWorld.WS == null) Console.WriteLine("NO WORLD STATE");
